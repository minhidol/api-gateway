// export function  rsError = (ErrorCode: any, Message: any) => {
...
//     return { ErrorCode: 401, Message: "Unauthenticated", Result: null };
//   };
  ...
  export function rsErrorPermission () {
    return { ErrorCode: 400, Message: "Permission denied", Result: null };
  };
  
  // exports.rsErrorOperation = (error: any) => {
  //   return {
  //     ErrorCode: 402,
  ...
  // exports.rsWarning = (Result = null) => {
  //   return { ErrorCode: 0, Message: "Warning: file_time > 6", Result };
  // };
